...
- 添加了`Coroutine\Server`的`onWorkerExitTimeout`事件，允许在Worker进程退出超时时执行自定义代码。
...
- 重構原生的curl以支持具有多个套接字的curl句柄，例如curl FTP协议
...
- 修复 WebSocket 的 finish 属性无效的问题 (#3410) (@matyhtf)
...
- 修复不完整協程 HTTP 伺服器請求原文 (#3079) (#3085) (@hantaohuang)
