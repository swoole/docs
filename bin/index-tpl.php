...
<head>
    <meta charset="UTF-8">
    <title>Swoole Documents (<?=$title?>)</title>
        ...
        plugins: [
            function (hook, vm) {
                hook.beforeEach(function (html) {
                    ...
                    const issue =
                        '📝 Updated at：{docsify-updated} ' + '，[Edit](https://github.com/swoole/docs/edit/main/public/<?=$lang?>/' + page + '.md)\n';
                    return issue + html
                })
                ...
                hook.doneEach(function () {
                    ...
                    if (document.location.hash !== '#/') document.title += ' | Swoole Documents'
                })
            }
        ]
    }
